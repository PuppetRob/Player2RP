...
main = {
    alternativeHoseParticles = true, -- If the positioning of the water particles isn't correct, try enabling this. We've noticed this happen with some graphic mods.
