...
Config = {
	...
	Locations =  {
		...
		['OreBuyer'] = { -- The Locations of the ore buyers
			{ name = "Ore Buyer", coords = vector4(304.91, 2821.12, 43.44, 3.8), sprite = 568, col = 81, blipTrue = false, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
		...
		['JewelBuyer'] = { -- The Location of the jewel buyer, I left this as Vangelico, others will proabably change to pawn shops
			{ name = "Jewel Buyer", coords = vector4(1651.56, 4879.98, 42.16, 11.32), sprite = 527, col = 617, blipTrue = false, model = `S_M_M_HighSec_03`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
	},
