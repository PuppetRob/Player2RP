...
Config = {
	...
	Jobs = {
		...
		['galaxy'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['whitewidow'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		['cyberbar'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, },
		...
		['hayesauto'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.10, },
		['bikemechanic'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.10, },
		['tunershop'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.10, },
		['boxgym'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 1.0, },
    ...
    CustomCashRegisters = {
	["galaxy"] = { -- Player job role restriction
		  { coords = vector4(351.88, 285.89, 91.20, 349.81), prop = true, }, -- vector4 to place the till and the way it faces
		  { coords = vector4(358.95, 280.66, 94.19, 75.05), prop = true, }, -- "prop = true" spawns a prop at the coords
		  { coords = vector4(344.99, 285.11, 95.79, 255.01), prop = true, },
		},
	["beanmachine"] = { -- Player job role restriction
		{ coords = vector4(122.55, -1036.04, 29.20, 250.29), prop = true, }, -- vector4 to place the till and the way it faces
		},
	["boxgym"] = { -- Player job role restriction
	  { coords = vector4(384.67, -1097.10, 29.40, 15.51), prop = true, }, -- vector4 to place the till and the way it faces
	 },
  },
