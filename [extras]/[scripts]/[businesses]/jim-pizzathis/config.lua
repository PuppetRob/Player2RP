...
Config = {
	...
	Locations = {
		{	zoneEnable = true,
			...
			zones = {
				vector2(776.81756591797, -709.84759521484),
				vector2(816.01745605469, -715.92181396484),
				vector2(830.05023193359, -770.56805419922),
				vector2(776.10174560547, -769.43725585938)
			},

			blip = vec3(806.97, -759.59, 26.78), blipcolor = 7, blipsprite = 267, blipscale = 0.5, blipdisp = 6, blipcat = nil,
	...
	DrinkItems = {
		...
		items = {
			...
			{ name = "vodka", price = 0, amount = 50, info = {}, type = "item", slot = 4, },
