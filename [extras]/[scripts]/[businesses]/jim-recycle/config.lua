...
Config = {
	...
	PayAtDoor = 250, -- Set to nil stop turn this off, set to a number to enable
	...
	Locations =  {
		['Recycle'] = {
			{ name = "Recycle Center", coords = vector4(346.81, 3405.47, 36.85, 20.5), blipTrue = false, sprite = 365, col = 2, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
		['Trade'] ={
		...
		['BottleBanks'] = { 
			{ name = "Bottle Bank", coords = vector4(2340.66, 3126.46, 47.21, 349.85), blipTrue = false, sprite = 642, col = 2, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
