...
CreateThread(function()
    for _, v in pairs(Config.Locations) do
        if v.zoneEnable then
            if v.zones then
                ...
                JobLocation:onPlayerInOut(function(isPointInside)
                    if PlayerJob.name == v.job then
                        if v.autoClock.enter then if isPointInside and not onDuty then if Config.Debug then print(onDuty) end TriggerServerEvent("QBCore:ToggleDuty") end end
                        if v.autoClock.exit then if not isPointInside and onDuty then if Config.Debug then print(onDuty) end TriggerServerEvent("QBCore:ToggleDuty") end end
                    end
                end)
            end
            if v.blip then makeBlip({coords = v.blip, sprite = v.blipsprite, col = v.blipcolor, name = v.label }) end
            local bossroles = {}
            ...
            if v.MLO == "mosbaek" then loc = v[v.MLO]
                Props[#Props+1] = makeProp({prop = `prop_cooker_03`, coords = loc.Targets.EdibleLoc}, true, false)
                ...
                Targets["StrainOne"] =
                    exports['qb-target']:AddBoxZone("StrainOne", vec3(loc.Strain.StrainOne.x, loc.Strain.StrainOne.y, loc.Strain.StrainOne.z-1), 5.0, 0.6,
                    { name="StrainOne", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainOne.z-1.03, maxZ = loc.Strain.StrainOne.z+0.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainOne, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainOne.xyz, }, }, distance = 1.0 })
                Targets["StrainTwo"] =
                    exports['qb-target']:AddBoxZone("StrainTwo", vec3(loc.Strain.StrainTwo.x, loc.Strain.StrainTwo.y, loc.Strain.StrainTwo.z-1), 5.0, 0.6,
                    { name="StrainTwo", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainTwo.z-1.03, maxZ = loc.Strain.StrainTwo.z+0.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainTwo, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainTwo.xyz, }, }, distance = 1.0 })
                Targets["StrainThree"] =
                    exports['qb-target']:AddBoxZone("StrainThree", vec3(loc.Strain.StrainThree.x, loc.Strain.StrainThree.y, loc.Strain.StrainThree.z-1), 5.0, 0.6,
                    { name="StrainThree", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainThree.z-1.03, maxZ = loc.Strain.StrainThree.z+0.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainThree, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainThree.xyz, }, }, distance = 1.0 })
                Targets["StrainFour"] =
                    exports['qb-target']:AddBoxZone("StrainFour", vec3(loc.Strain.StrainFour.x, loc.Strain.StrainFour.y, loc.Strain.StrainFour.z-1), 5.0, 0.6,
                    { name="StrainFour", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainFour.z-1.03, maxZ = loc.Strain.StrainFour.z+0.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainFour, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainFour.xyz, }, }, distance = 1.0 })
                Targets["StrainFive"] =
                    exports['qb-target']:AddBoxZone("StrainFive", vec3(loc.Strain.StrainFive.x, loc.Strain.StrainFive.y, loc.Strain.StrainFive.z-1), 6.0, 0.6,
                    { name="StrainFive", heading = 340, debugPoly = Config.Debug, minZ = loc.Strain.StrainFive.z-1.03, maxZ = loc.Strain.StrainFive.z+1.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainFive, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainFive.xyz, }, }, distance = 1.0 })
                Targets["StrainSix"] =
                    exports['qb-target']:AddBoxZone("StrainSix", vec3(loc.Strain.StrainSix.x, loc.Strain.StrainSix.y, loc.Strain.StrainSix.z-1), 6.0, 0.6,
                    { name="StrainSix", heading = 340, debugPoly = Config.Debug, minZ = loc.Strain.StrainSix.z-1.03, maxZ = loc.Strain.StrainSix.z+1.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainSix, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainSix.xyz, }, }, distance = 1.0 })
                Targets["StrainSeven"] =
                    exports['qb-target']:AddBoxZone("StrainSeven", vec3(loc.Strain.StrainSeven.x, loc.Strain.StrainSeven.y, loc.Strain.StrainSeven.z-1), 6.0, 0.6,
                    { name="StrainSeven", heading = 340, debugPoly = Config.Debug, minZ = loc.Strain.StrainSeven.z-1.03, maxZ = loc.Strain.StrainSeven.z+1.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainSeven, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainSeven.xyz, }, }, distance = 1.0 })
                Targets["StrainEight"] =
                    exports['qb-target']:AddBoxZone("StrainEight", vec3(loc.Strain.StrainEight.x, loc.Strain.StrainEight.y, loc.Strain.StrainEight.z-1), 6.0, 0.6,
                    { name="StrainEight", heading = 340, debugPoly = Config.Debug, minZ = loc.Strain.StrainEight.z-1.03, maxZ = loc.Strain.StrainEight.z+1.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainEight, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainEight.xyz, }, }, distance = 1.0 })

                --JOINTS
                Targets["WWJoints"] =
                    exports['qb-target']:AddBoxZone("WWJoints", vec3(loc.Targets.JointsLoc.x, loc.Targets.JointsLoc.y, loc.Targets.JointsLoc.z-1), 0.6, 2.0,
                    { name="WWJoints", heading = 339.79, debugPoly = Config.Debug, minZ = loc.Targets.JointsLoc.z-1.03, maxZ = loc.Targets.JointsLoc.z, },
                    { options = { { event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["joints"], craftable = Crafting.Joints, header = Loc[Config.Lan].menu["header_joints"], coords = loc.Targets.JointsLoc.xyz, }, }, distance = 2.0 })

                -- TRIMMING
                Targets["WWTrimming"] =
                    exports['qb-target']:AddBoxZone("WWTrimming", vec3(loc.Targets.TrimmingLoc.x, loc.Targets.TrimmingLoc.y, loc.Targets.TrimmingLoc.z-1), 0.6, 2.0,
                    { name="WWTrimming", heading = 248.5, debugPoly = Config.Debug, minZ = loc.Targets.TrimmingLoc.z-1.03, maxZ = loc.Targets.TrimmingLoc.z, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["trimming"], craftable = Crafting.Trimming, header = Loc[Config.Lan].menu["header_trimming"], coords = loc.Targets.TrimmingLoc.xyz, }, }, distance = 2.0 })

                --COOKING--
                Targets["WWEdibleOven"] =
                    exports['qb-target']:AddBoxZone("WWEdibleOven", vec3(loc.Targets.EdibleLoc.x, loc.Targets.EdibleLoc.y, loc.Targets.EdibleLoc.z-1), 0.9, 1.7,
                    { name="WWEdibleOven", heading = loc.Targets.EdibleLoc.w, debugPoly = Config.Debug, minZ = loc.Targets.EdibleLoc.z-1.03, maxZ = loc.Targets.EdibleLoc.z, },
                    { options = { { event = "jixel-whitewidow:Crafting", icon = "fas fa-utensil-spoon", job = v.job, label =Loc[Config.Lan].target["oven"], craftable = Crafting.Edibles, header = Loc[Config.Lan].menu["header_oven"], coords = loc.Targets.EdibleLoc.xyz, }, }, distance = 2.0 })

                --WORKER ITEMS --
                Targets["WWShop"] =
                    exports['qb-target']:AddBoxZone("WWShop", vec3(loc.Targets.StoreLoc.x, loc.Targets.StoreLoc.y, loc.Targets.StoreLoc.z-1), 0.6, 2.0,
                    { name="WWShop", heading = loc.Targets.StoreLoc.w, debugPoly=Config.Debug, minZ = loc.Targets.StoreLoc.z-1.03, maxZ= loc.Targets.StoreLoc.z+1, },
                    { options = { {  event = "jixel-whitewidow:Shop", icon = "fas fa-box-open", label = Loc[Config.Lan].target["store"], job = v.job, wjob = v.job, coords = loc.Targets.StoreLoc.xyz, }, }, distance = 2.0 })

                --STORAGE
                Targets["WWWeedPrepared"] =
                    exports['qb-target']:AddBoxZone("WWWeedPrepared", vec3(loc.Targets.PreppedStorage.x, loc.Targets.PreppedStorage.y, loc.Targets.PreppedStorage.z-1), 0.6, 2.8,
                    { name="WWWeedPrepared", heading = 249.94, debugPoly=Config.Debug, minZ= loc.Targets.PreppedStorage.z-1, maxZ= loc.Targets.PreppedStorage.z+1 },
                    { options = { {  event = "jixel-whitewidow:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].target["weed"], job = v.job, stash = "WWShelf_1", coords = loc.Targets.PreppedStorage.xyz, }, },  distance = 2.0 })
                Targets["WWWeedPrepared2"] =
                    exports['qb-target']:AddBoxZone("WWWeedPrepared2", vec3(loc.Targets.PreppedStorage2.x, loc.Targets.PreppedStorage2.y, loc.Targets.PreppedStorage2.z-1), 0.6, 2.8,
                    { name="WWWeedPrepared2", heading = 160.25, debugPoly=Config.Debug, minZ= loc.Targets.PreppedStorage2.z-1.03, maxZ= loc.Targets.PreppedStorage2.z+1 },
                    { options = { {  event = "jixel-whitewidow:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].target["weed"], job = v.job, stash = "WWShelf_2", coords = loc.Targets.PreppedStorage2.xyz, }, },  distance = 2.0 })
                Targets["WWEmployeeStorage"] =
                    exports['qb-target']:AddBoxZone("WWEmployeeStorage", vec3(loc.Targets.EmployeeStorage.x, loc.Targets.EmployeeStorage.y, loc.Targets.EmployeeStorage.z-1), 2.0, 0.9,
                    { name="WWEmployeeStorage", heading = 160.25, debugPoly=Config.Debug, minZ= loc.Targets.EmployeeStorage.z-1.03, maxZ= loc.Targets.EmployeeStorage.z }, { options = {
                        {  event = "jixel-whitewidow:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].target["weed"], job = v.job, stash = "WWShelf_3", coords = loc.Targets.EmployeeStorage.xyz, },
            ...
            elseif v.MLO == "jenww" then loc = v[v.MLO]
                Props[#Props+1] = makeProp({prop = "prop_griddle_02", coords = loc.Targets.EdibleLoc}, true, false)
                ...
                --HARVESTING--
                Targets["StrainOneJC"] =
                    exports['qb-target']:AddBoxZone("StrainOneJC", vec3(loc.Strain.StrainOne.x, loc.Strain.StrainOne.y, loc.Strain.StrainOne.z-1), 1.2, 1.2,
                    { name="StrainOneJC", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainOne.z-0.3, maxZ = loc.Strain.StrainOne.z+1.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainOne, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainOne.xyz, }, }, distance = 1.0 })
                    Targets["StrainTwoJC"] =
                    exports['qb-target']:AddBoxZone("StrainTwoJC", vec3(loc.Strain.StrainTwo.x, loc.Strain.StrainTwo.y, loc.Strain.StrainTwo.z-1), 0.8, 0.8,
                    { name="StrainTwoJC", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainTwo.z-1.03, maxZ = loc.Strain.StrainTwo.z+0.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainTwo, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainTwo.xyz, }, }, distance = 1.0 })
                Targets["StrainThreeJC"] =
                    exports['qb-target']:AddBoxZone("StrainThreeJC", vec3(loc.Strain.StrainThree.x, loc.Strain.StrainThree.y, loc.Strain.StrainThree.z-1), 0.8, 0.8,
                    { name="StrainThreeJC", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainThree.z-1.03, maxZ = loc.Strain.StrainThree.z+0.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainThree, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainThree.xyz, }, }, distance = 1.0 })
                Targets["StrainFourJC"] =
                    exports['qb-target']:AddBoxZone("StrainFourJC", vec3(loc.Strain.StrainFour.x, loc.Strain.StrainFour.y, loc.Strain.StrainFour.z-1), 0.8, 0.8,
                    { name="StrainFourJC", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainFour.z-1.03, maxZ = loc.Strain.StrainFour.z+0.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainFour, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainFour.xyz, }, }, distance = 1.0 })
                Targets["StrainFiveJC"] =
                    exports['qb-target']:AddBoxZone("StrainFiveJC", vec3(loc.Strain.StrainFive.x, loc.Strain.StrainFive.y, loc.Strain.StrainFive.z), 0.8, 0.8,
                    { name="StrainFiveJC", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainFive.z-0.3, maxZ = loc.Strain.StrainFive.z+1.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainFive, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainFive.xyz, }, }, distance = 1.0 })
                Targets["StrainSixJC"] =
                    exports['qb-target']:AddBoxZone("StrainSixJC", vec3(loc.Strain.StrainSix.x, loc.Strain.StrainSix.y, loc.Strain.StrainSix.z-1), 1.2, 1.2,
                    { name="StrainSix", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainSix.z-0.3, maxZ = loc.Strain.StrainSix.z+1.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainSix, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainSix.xyz, }, }, distance = 1.0 })
                Targets["StrainSevenJC"] =
                    exports['qb-target']:AddBoxZone("StrainSevenJC", vec3(loc.Strain.StrainSeven.x, loc.Strain.StrainSeven.y, loc.Strain.StrainSeven.z-1), 0.8, 0.8,
                    { name="StrainSevenJC", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainSeven.z-0.3, maxZ = loc.Strain.StrainSeven.z+1.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainSeven, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainSeven.xyz, }, }, distance = 1.0 })
                Targets["StrainEightJC"] =
                    exports['qb-target']:AddBoxZone("StrainEightJC", vec3(loc.Strain.StrainEight.x, loc.Strain.StrainEight.y, loc.Strain.StrainEight.z-1), 1.0, 1.0,
                    { name="StrainEightJC", heading = 70, debugPoly = Config.Debug, minZ = loc.Strain.StrainEight.z-0.3, maxZ = loc.Strain.StrainEight.z+1.5, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["harvest"], craftable = Crafting.Strains.StrainEight, header = Loc[Config.Lan].menu["header_harvest"], coords = loc.Strain.StrainEight.xyz, }, }, distance = 1.0 })

                --JOINTS--
                Targets["JCJoints"] =
                    exports['qb-target']:AddBoxZone("JCJoints", vec3(loc.Targets.JointsLoc.x, loc.Targets.JointsLoc.y, loc.Targets.JointsLoc.z-1), 1.0, 2.2,
                    { name="JCJoints", heading = 338, debugPoly = Config.Debug, minZ = loc.Targets.JointsLoc.z-1.03, maxZ = loc.Targets.JointsLoc.z, },
                    { options = { { event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["joints"], craftable = Crafting.Joints, header = Loc[Config.Lan].menu["header_joints"], coords = loc.Targets.JointsLoc.xyz, }, }, distance = 2.0 })

                Targets["JCTrimming"] =
                    exports['qb-target']:AddBoxZone("JCTrimming", vec3(loc.Targets.TrimmingLoc.x, loc.Targets.TrimmingLoc.y, loc.Targets.TrimmingLoc.z-1), 1.0, 2.2,
                    { name="JCTrimming", heading = 338, debugPoly = Config.Debug, minZ = loc.Targets.TrimmingLoc.z-1.03, maxZ = loc.Targets.TrimmingLoc.z, },
                    { options = { { item = "trimmers", event = "jixel-whitewidow:Crafting", icon = "fas fa-cannabis", job = v.job, label = Loc[Config.Lan].target["trimming"], craftable = Crafting.Trimming, header = Loc[Config.Lan].menu["header_trimming"], }, }, distance = 2.0 })

                --COOKING--
                Targets["JCEdibleOven"] =
                    exports['qb-target']:AddBoxZone("JCEdibleOven", vec3(loc.Targets.EdibleLoc.x, loc.Targets.EdibleLoc.y, loc.Targets.EdibleLoc.z-1), 0.8, 0.8,
                    { name="JCEdibleOven", heading = loc.Targets.EdibleLoc.w, debugPoly = Config.Debug, minZ = loc.Targets.EdibleLoc.z-1.03, maxZ = loc.Targets.EdibleLoc.z, },
                    { options = { { event = "jixel-whitewidow:Crafting", icon = "fas fa-utensil-spoon", job = v.job, label =Loc[Config.Lan].target["oven"], craftable = Crafting.Edibles, header = Loc[Config.Lan].menu["header_oven"], coords = loc.Targets.EdibleLoc.xyz, }, }, distance = 2.0 })
                Targets["JCCoffee"] =
                    exports['qb-target']:AddBoxZone("JCCoffee", vec3(loc.Targets.CoffeeLoc.x, loc.Targets.CoffeeLoc.y, loc.Targets.CoffeeLoc.z-1), 0.4, 0.4,
                    { name="JCCoffee", heading = 250, debugPoly = Config.Debug, minZ = loc.Targets.CoffeeLoc.z-1.03, maxZ = loc.Targets.CoffeeLoc.z, },
                    { options = { { event = "jixel-whitewidow:Crafting", icon = "fas fa-utensil-spoon", item = "trimmers", label = Loc[Config.Lan].target["coffee"], craftable = Crafting.Coffee, header = Loc[Config.Lan].menu["header_coffee"], coords = loc.Targets.CoffeeLoc.xyz, }, }, distance = 2.0 })

                --WORKER ITEMS --
                Targets["JCShop"] =
                    exports['qb-target']:AddBoxZone("JCShop", vec3(loc.Targets.StoreLoc.x, loc.Targets.StoreLoc.y, loc.Targets.StoreLoc.z-1), 2.1, 3.5,
                    { name="JCShop", heading = loc.Targets.StoreLoc.w, debugPoly=Config.Debug, minZ = loc.Targets.StoreLoc.z-1.03, maxZ=loc.Targets.StoreLoc.z+1, },
                    { options = { {  event = "jixel-whitewidow:Shop", icon = "fas fa-box-open", label = Loc[Config.Lan].target["store"], job = v.job, wjob = v.job, coords = loc.Targets.StoreLoc.xyz, }, }, distance = 2.0 })

                --STORAGE
                Targets["JCWeedPrepared"] =
                    exports['qb-target']:AddBoxZone("JCWeedPrepared", vec3(loc.Targets.PreppedStorage.x, loc.Targets.PreppedStorage.y, loc.Targets.PreppedStorage.z-1), 5.5, 1.2,
                    { name="JCWeedPrepared", heading = loc.Targets.PreppedStorage.w, debugPoly=Config.Debug, minZ=loc.Targets.PreppedStorage.z-1, maxZ=loc.Targets.PreppedStorage.z+1 },
                    { options = { {  event = "jixel-whitewidow:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].target["weed"], job = v.job, stash = "WWShelf_1", coords = loc.Targets.PreppedStorage.xyz, }, },  distance = 2.0 })

                Targets["JCWeedPrepared2"] =
                    exports['qb-target']:AddBoxZone("JCWeedPrepared2", vec3(loc.Targets.PreppedStorage2.x, loc.Targets.PreppedStorage2.y, loc.Targets.PreppedStorage2.z-1), 5.5, 1.2,
                        { name="JCWeedPrepared2", heading = loc.Targets.PreppedStorage2.w, debugPoly=Config.Debug, minZ=loc.Targets.PreppedStorage2.z-1, maxZ=loc.Targets.PreppedStorage2.z+1 },
                        { options = { {  event = "jixel-whitewidow:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].target["weed"], job = v.job, stash = "WWShelf_2", coords = loc.Targets.PreppedStorage2.xyz, }, },  distance = 2.0 })

                Targets["JCWeedPrepared3"] =
                    exports['qb-target']:AddBoxZone("JCWeedPrepared3", vec3(loc.Targets.PreppedStorage3.x, loc.Targets.PreppedStorage3.y, loc.Targets.PreppedStorage3.z-1), 5.5, 1.2,
                        { name="JCWeedPrepared3", heading = loc.Targets.PreppedStorage.w, debugPoly=Config.Debug, minZ=loc.Targets.PreppedStorage3.z-1, maxZ=loc.Targets.PreppedStorage3.z+1 },
                        { options = { {  event = "jixel-whitewidow:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].target["weed"], job = v.job, stash = "WWShelf_3", coords = loc.Targets.PreppedStorage3.xyz, }, },  distance = 2.0 })
                Targets["JCWeedPrepared4"] =
                    exports['qb-target']:AddBoxZone("JCWeedPrepared4", vec3(loc.Targets.EmployeeStorage.x, loc.Targets.EmployeeStorage.y, loc.Targets.EmployeeStorage.z-1), 0.6, 2.2,
                        { name="JCWeedPrepared4", heading = loc.Targets.EmployeeStorage.w, debugPoly=Config.Debug, minZ=loc.Targets.EmployeeStorage.z-1, maxZ=loc.Targets.EmployeeStorage.z+1 },
                        { options = { {  event = "jixel-whitewidow:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].target["weed"], job = v.job, stash = "WWShelf_4", coords = loc.Targets.EmployeeStorage.xyz, }, },  distance = 2.0 })
                ...
                Targets["JCTable"] =
                    ...
                    { event = "jixel-whitewidow:Crafting:TableBong", icon = "fas fa-cannabis", label = Loc[Config.Lan].target["bong"], coords = vec3(193.68, -233.19, 53.6), craftable = Crafting.TableBong, header = Loc[Config.Lan].menu["header_tablebong"], },
                    }, distance = 2.0 })
                Targets["JCTable2"] =
                    ...
                    { event = "jixel-whitewidow:Crafting:TableBong", icon = "fas fa-cannabis", label = Loc[Config.Lan].target["bong"], coords = vec3(188.69, -265.08, 54.1), craftable = Crafting.TableBong, header = Loc[Config.Lan].menu["header_tablebong"], },
                    }, distance = 2.0 })
