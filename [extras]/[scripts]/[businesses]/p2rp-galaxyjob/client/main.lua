                    ...
                    if StashDistance < 20 then
                        ...
                        if StashDistance < 1 then
                            ...
                            if IsControlJustReleased(0, 38) then
                                TriggerEvent("inventory:client:SetCurrentStash", "galaxystash")
                                TriggerServerEvent("inventory:server:OpenInventory", "stash", "galaxystash", {
                                    maxweight = 4000000,
                                    slots = 500,
                                })
                            end
