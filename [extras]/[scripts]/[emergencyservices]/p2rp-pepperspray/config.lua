...
Config = {
    ...
    CheckVersion = false, -- Checks if an update is needed, the message will be put in the server console when the resource is started
    ...
    RechargeCoords = { -- Coordinated to recharge the pepper spray and decontamination spray
        vector3(382.96, -1616.13, 29.29),
        vector3(844.01, -1311.52, 26.27),
        vector3(1555.93, 827.48, 77.14),
        vector3(456.13, -1000.13, 25.7),
    },
    RechargeRadius = 3.0, -- Distance to recharge

    DisableControl = {
        sprint = true, -- Activate or not the fact of running when the person is gassed
        enterVehicle = false, -- Activate or disable the ability to get into a vehicle when it is gassed
        fight = false -- Active or disable the fact of fighting when the person is gassed
    },
