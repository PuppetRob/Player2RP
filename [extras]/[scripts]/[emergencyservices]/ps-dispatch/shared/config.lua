...
Config.RespondKeybind = '8'
Config.OpenDispatchMenu = 'O'
Config.AlertTime = 8     -- Specify the duration for the alert to appear on the screen. The default time is 5 seconds for all alerts. To set a different duration for specific alerts, change the value in `alertTime = nil` found in the alerts.lua file.
...
Config.WeaponWhitelist = {
    ...
    "WEAPON_PLASMAP_BLUE",
	"WEAPON_PLASMAP_RED",
	"WEAPON_RAZORBACK_BLUE",
	"WEAPON_RAZORBACK_RED",
	"WEAPON_NEEDLER2_BLUE",
	"WEAPON_NEEDLER2_RED",
