...
Config = {
    -- DEBUG --
    NumberCommand = 'dholster', -- The command to find your current peds holster information to use in the config options below.
    BeltCommand = 'dbelt', -- The command to find your current peds belt information to use in the config options below.
    -- ANIMATIONS --
    ...
    Holsters = { -- Add your holster EUP numbers below, don't ask for assistance with this as every server is different.
        Male = {
            [8] = {New = 2, isEmpty = false}, -- You need to have a holster that is empty and not empty for this to work properly with each entry.
            [2] = {New = 8, isEmpty = true}
        },
        Female = {
            [8] = {New = 2, isEmpty = false},
            [2] = {New = 8, isEmpty = true}
        }
    },
    -- DYNAMIC BELTS --
