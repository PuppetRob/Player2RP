...
local props = {
    ...
    ["coffeemaker"]    = { carry = true, model = "prop_coffee_mac_02", bone = 24817, x = 0.00, y = 0.43, z = 0.05,
        xr = 91.0, yr = 0.0, zr = -265.0, blockAttack = true, blockCar = true, blockRun = true },
    ["flight_artpiece"]    = { carry = true, model = "v_res_sculpt_decf", bone = 24817, x = -0.25, y = 0.43, z = 0.00,
        xr = 0.0, yr = 90.0, zr = 0.0, blockAttack = true, blockCar = true, blockRun = true },
    ["musicequipment"] = { carry = true, model = "prop_speaker_06", bone = 24817, x = 0.00, y = 0.43, z = 0.05, xr = 91.0,
        yr = 0.0, zr = -265.0, blockAttack = true, blockCar = true, blockRun = true },
    ["microwave"]      = { carry = true, model = "prop_microwave_1", bone = 24817, x = -0.20, y = 0.43, z = 0.05, xr = 91.0,
        yr = 0.0, zr = -265.0, blockAttack = true, blockCar = true, blockRun = true },
    ["flight_suitcase"]      = { carry = true, model = "prop_ld_suitcase_01", bone = 24817, x = -0.10, y = 0.43, z = 0.05, xr = 0.0,
        yr = 90.0, zr = 0.0, blockAttack = true, blockCar = true, blockRun = true },
    ["flight_television"]      = { carry = true, model = "sm_prop_smug_tv_flat_01", bone = 24817, x = -0.20, y = 0.43, z = 0.05, xr = 0.0,
        yr = -90.0, zr = 200.0, blockAttack = true, blockCar = true, blockRun = true },
    ["flight_painting"]    = { carry = true, model = "ch_prop_vault_painting_01c", bone = 24817, x = -0.25, y = 0.43, z = 0.05, xr = 180.0,
        yr = 90.0, zr = 0.0, blockAttack = true, blockCar = true, blockRun = true },
    ["flight_painting2"]    = { carry = true, model = "ch_prop_vault_painting_01d", bone = 24817, x = -0.25, y = 0.43, z = 0.05, xr = 180.0,
        yr = 90.0, zr = 0.0, blockAttack = true, blockCar = true, blockRun = true },
    ["flight_guitar"]      = { carry = true, model = "sf_prop_sf_guitar_case_01a", bone = 24817, x = -0.15, y = 0.50, z = 0.05, xr = 90.0,
