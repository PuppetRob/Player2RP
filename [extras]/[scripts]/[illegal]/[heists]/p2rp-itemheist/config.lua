...
Config.RequiredPolice = 4 -- Needed cops to start the mission

Config.PoliceJob = 'leo' -- Police job

Config.UseBlips = false

Config.Phone = 'qs-smartphone'

Config.ThermiteItem = 'c4_bomb'
...
Config.Guards = {
    ...
    [7] = {
        Coords = vector4(-2130.39, 3226.52, 32.81, 62.37),
        Ped = 's_m_y_blackops_01',
        Weapon = 'WEAPON_CARBINERIFLE',
        Health = 3000,
        Accuracy = 80,
    ...
    [8] = {
        Coords = vector4(-2108.46, 3279.93, 38.73, 136.18),
        Ped = 's_m_y_blackops_01',
        Weapon = 'WEAPON_CARBINERIFLE',
        Health = 3000,
        Accuracy = 80,
    ...
    [9] = {
        Coords = vector4(-2133.9, 3300.03, 32.81, 186.99),
        Ped = 's_m_y_blackops_01',
        Weapon = 'WEAPON_CARBINERIFLE',
        Health = 3000,
        Accuracy = 80,
