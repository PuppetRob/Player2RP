...
AddEventHandler('pacificheist:client:startHeist', function()
    TriggerEvent("QBCore:Notify", "Pacific Bank Heist Started", 'success')
    ...
    QBCore.Functions.TriggerCallback('pacificheist:server:hasItem', function(hasItem, itemLabel)
        if hasItem then
            ...
            if hackStatus then
               ...
               -- TriggerServerEvent("rm_pacificheist:server:callCops", "Pacific Bank", streetLabel, coords)
...
AddEventHandler('pacificheist:client:sceneSync', function(model, animDict, animName, pos, rotation)--outside()
    loadAnimDict(animDict)
