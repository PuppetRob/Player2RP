...
Config['PacificHeist'] = {
    ...
    ['rewardItems'] = { -- Add this items to database or shared. Don't change the order, you can change the item names. Also dont forget glass cutting and painting item names.(in bottom)
        ...
        {itemName = 'uncut_ruby', sellPrice = 100},
    },
    ...
    ['startHeist'] ={ -- heist start coords
        pos = vector3(705.45, -965.78, 30.4),
        peds = {
            {pos = vector3(705.45, -965.78, 30.4), heading = 288.79, ped = 's_m_m_chemsec_01'},
         --   {pos = vector3(-47.0, 1943.87, 190.19), heading = 23.78, ped = 's_m_m_highsec_02'},
         --   {pos = vector3(-46.06, 1943.5, 190.18), heading = 228.42, ped = 's_m_m_fiboffice_02'}
        }
    },
--[[     ['finishHeist'] = {
