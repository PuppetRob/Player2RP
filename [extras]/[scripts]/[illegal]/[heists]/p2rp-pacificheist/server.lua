...
RegisterServerEvent('rm_pacificheist:server:callCops')
AddEventHandler('rm_pacificheist:server:callCops', function(type, streetLabel, coords)
    local data = {displayCode = '10-68', description = 'Pacific Bank Robbery', isImportant = 0, recipientList = {'police'}, length = '20000', infoM = 'fa-info-circle', info = 'Pacific Bank Robbery In Progress'}
    local dispatchData = {dispatchData = data, caller = 'Alarm', coords = vector3(257.10, 220.30, 106.28)}
...
AddEventHandler('pacificheist:server:startHeist', function()
    TriggerClientEvent('QBCore:Notify', source, 'Pacific Bank Heist Started', 'success')
