...
Config['ShopRobbery'] = {
    ...
    ['dispatchJobs'] = {'lspd', 'bcso', 'highwaypatrol'},
    ...
    ['rewardItems'] = { -- Add this items to database or shared. Don't change the order, you can change the item names.
        {itemName = 'goldbar', count = math.random(1, 2)}, -- For safecrack reward
        {itemName = 'diamond', count = math.random(5, 10)}, -- For safecrack reward
    },
    ['rewardMoneys'] = {
        ['safecrack'] = function()
            return math.random(1500, 4000) -- For safecrack money reward
        end,
    ...
    ['clerkWeapon'] = GetHashKey('weapon_assaultshotgun'), -- Clerk weapon
