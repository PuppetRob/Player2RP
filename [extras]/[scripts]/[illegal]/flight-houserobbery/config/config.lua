...
Config.RewardsIPL = {
    ...
    [2] = { -- IPL Tier
        ...
        ["kitchen"] = { 
            ...
            [4] = {name = "burnerphone", amount = {min = 1, max = 2}, chance = {min = 76, max = 100}}, -- 'amount' is how many of that item, 'chance' gets a random number, if that number is between min and max, you get the item
        },
        ["chest"] = { 
        ...
        ["livingroom"] = { 
            ...
            [3] = {name = "advancedlockpick", amount = {min = 1, max = 1}, chance = {min = 51, max = 75}}, -- 'amount' is how many of that item, 'chance' gets a random number, if that number is between min and max, you get the item
    ...
    [3] = { -- IPL Tier
        ...
        ["kitchen"] = { 
            ...
            [4] = {name = "burnerphone", amount = {min = 1, max = 3}, chance = {min = 76, max = 100}}, -- 'amount' is how many of that item, 'chance' gets a random number, if that number is between min and max, you get the item
        }, 
        ["chest"] = { 
...
Config.RewardsShell = {
    ...
    [2] = { -- Shell Tier
        ...
        ["livingroom"] = {
            ...
            [3] = {name = "blueprint_smg-receiver", amount = {min = 1, max = 1}, chance = {min = 51, max = 75}}, -- 'amount' is how many of that item, 'chance' gets a random number, if that number is between min and max, you get the item
            [4] = {name = "diamond_ring", amount = {min = 1, max = 1}, chance = {min = 76, max = 100}}, -- 'amount' is how many of that item, 'chance' gets a random number, if that number is between min and max, you get the item
        }, 
    },
    [3] = { -- Shell Tier
