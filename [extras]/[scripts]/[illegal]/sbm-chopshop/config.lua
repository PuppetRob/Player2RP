...
Config.CoolDown = 1       -- How long people must wait before starting another job (in minutes)

Config.StartLoc = vector4(752.4, -1206.41, 24.76, 96.32)  -- Starting Location with target and PED
...
Config.DeliveryCoords = {  -- Locations for the scrapyards **Chosen from random every time you start a new job**
    [1] = {
        coords = vector4(-468.3, -1676.83, 19.05, 344.3),
    },
    [2] = {
        coords = vector4(110.6, 6625.99, 31.79, 40.79),
    },
    [3] = {
        coords = vector4(1729.04, 3321.55, 40.99, 16.81),
    },
    [4] = {
        coords = vector4(730.69, -1088.38, 22.17, 270.29),
    },
}
