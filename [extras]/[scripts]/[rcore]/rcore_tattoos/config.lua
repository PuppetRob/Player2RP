...
Config.Shops = {
  --[[   {   -- Tattoo shop with custom blip
    ...
    -----------------------------------------------
    {   -- Tattoo shop without map blip --- AOD
        pos = vector3(2511.58, 4089.57, 35.59),
        marker = Config.DefaultMarkerSettings
    },
--[[     {   -- Preview tattoo shop to choose a tattoo without possibility to buy
    onlyPreview = true,
    ...
    -----------------------------------------------
    {   -- Tattoo shop without map blip --- Vinewood Boulevard
    pos = vector3(324.56, 180.96, 103.59),
    marker = Config.DefaultMarkerSettings
    },
--[[     {   -- Preview tattoo shop to choose a tattoo without possibility to buy
    onlyPreview = true,
    ...
    -----------------------------------------------
    {   -- Tattoo shop without map blip --- Route 1 on left
...
--[[     {   -- Preview tattoo shop to choose a tattoo without possibility to buy
    ...
    -----------------------------------------------
    {   -- Tattoo shop without map blip --- Sandy
...
--[[     {   -- Preview tattoo shop to choose a tattoo without possibility to buy
    ...
    -----------------------------------------------
    {   -- Tattoo shop without map blip --- Aqula Street near AOD
...
--[[     {   -- Preview tattoo shop to choose a tattoo without possibility to buy
    ...
    -----------------------------------------------
    {   -- Tattoo shop without map blip --- Fudge Lane
    pos = vector3(1322.2, -1654.11, 52.28),
    marker = Config.DefaultMarkerSettings
    },
--[[     {   -- Preview tattoo shop to choose a tattoo without possibility to buy
    onlyPreview = true,
    ...
    -----------------------------------------------
    {   -- Tattoo shop without map blip --- Paleto
    pos = vector3(-295.12, 6200.39, 31.49),
    marker = Config.DefaultMarkerSettings
    },
--[[     {   -- Preview tattoo shop to choose a tattoo without possibility to buy
    onlyPreview = true,
