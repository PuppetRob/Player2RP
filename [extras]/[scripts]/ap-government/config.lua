Config = {
	...
	DiscordWebhook = { -- Set the webhooks you want to use to true, add your webhook links to server/webhook.lua file at the top.
	  CandidateWinner = false, 
	  PollsOpen = false, 
	  CandidateStarted = false, 
	  CompanyRegisterd = false, 
	  CompanyGrantGiven = false, 
	  AppointmentRequest = false, 
	  MayorTaxChange = false, 
	  TerminateVoting = false,
	  NewLaw = false,
	  LawAgainst = false,
	  LawPassed = false,
	  LawRemoved = false
	...
	NotifyWinnerByPhone = false, -- Set true to email player of winning the election
	...
	Phone = {GKSPhone = false, QBPhone = true, QuasarPhone = true, QSPRO = false, HighPhone = false, LBPhone = false, Custom = false}, -- Set to the phone you use to true, if you do not have one of these phones then set Custom to true and edit the function in webhooks.lua.
