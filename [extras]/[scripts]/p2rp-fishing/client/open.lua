...
Citizen.CreateThread(function()
	...
	if Config.Target == "ox_target" and Config.InventoryType == "ox" then
		exports.ox_target:addBoxZone({
			coords = vector3(Config.TournamentPedLoc.x, Config.TournamentPedLoc.y, Config.TournamentPedLoc.z+1),
			size = vector3(1, 1, 1),
			rotation = 0,
			debug = Config.Debug,
			options = {
	...
	elseif Config.InventoryType == "ox" then
		exports[Config.Target]:AddBoxZone("fishguy",vector3(Config.TournamentPedLoc.x, Config.TournamentPedLoc.y, Config.TournamentPedLoc.z), 1, 1, {
			name="fishguy",
			heading=0,
	...
	if Config.Target == "ox_target" then
		exports.ox_target:addBoxZone({
			coords = vector3(Config.SellShopPedPedLoc.x, Config.SellShopPedPedLoc.y, Config.SellShopPedPedLoc.z+1),
			size = vector3(1, 1, 1),
			rotation = 330,
			debug = Config.Debug,
			options = {
		...
		exports[Config.Target]:AddBoxZone("sellfish", vector3(Config.SellShopPedPedLoc.x, Config.SellShopPedPedLoc.y, Config.SellShopPedPedLoc.z), 1, 1, {
			name="sellfish",
			heading=330,
			debugPoly= Config.Debug,
			minZ=28.55,
...
--[[ 	FishSellBlip = AddBlipForCoord(-2196.83, 4272.38, 48.55)
	...
	if Config.Target == "ox_target" then
		exports.ox_target:addBoxZone({
			coords = vector3(Config.CrafingRodLocation.x, Config.CrafingRodLocation.y, Config.CrafingRodLocation.z),
			size = vector3(1, 1, 1),
			rotation = 330,
			debug = Config.Debug,
			options = {
		...
		exports[Config.Target]:AddBoxZone("CraftFishingRod",vector3(Config.CrafingRodLocation.x, Config.CrafingRodLocation.y, Config.CrafingRodLocation.z), 1.4, 1, {
			name="CraftFishingRod",
			heading=335,
			debugPoly=Config.Debug,
			minZ=-100.33,
	...
	if Config.Target == "ox_target" then
		exports.ox_target:addBoxZone({
			coords = vector3(Config.GemsBuyingPedLoc.x, Config.GemsBuyingPedLoc.y, Config.GemsBuyingPedLoc.z+1),
			size = vector3(1, 1, 1),
			rotation = 330,
			debug = Config.Debug,
			options = {
		...
		exports[Config.Target]:AddBoxZone("gemsguy",vector3(Config.GemsBuyingPedLoc.x, Config.GemsBuyingPedLoc.y, Config.GemsBuyingPedLoc.z), 1, 1, {
			name="gemsguy",
			heading=330,
			debugPoly= Config.Debug,
			minZ=-100.3,
