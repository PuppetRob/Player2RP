...
Config.InventoryType = 'qb' -- (qb, ox, lj, neither) What inventory you are using? if you are using a renamed inventory resource you can use that here as well for qb-inventory or lj-inventory renames only.
Config.Phone = "qb" -- (quasar) (renewed) (gks) (qb) Whatever phone script you are using for email when a tournament starts. (event is "Pug:client:TournamentHasBecomeAvilable" in open.lua)
----------
...
----------
----------
Config.TournamentCooldowns = 5 -- (Minutes) how much time inbetween tournaments | Default is set to 2 hours and 30 minutes (# In minutes)
...
Config.TournamentTimeToSignUp = 5 -- (Minutes) How long do player have to sign up after a tournament becomes available aka how many seconds is Config.TournamentCooldowns | Default is set to 15 minutes
----------
----------
Config.TournamentPed = `s_m_m_trucker_01` -- Fishing Tournament ped
Config.TournamentPedLoc = vector4(-1614.68, 5260.55, 2.97, 243.97) -- tournament ped location
----------
----------
Config.SellShopPed = `s_m_m_migrant_01` -- Fishing sell shop ped model
Config.SellShopPedPedLoc = vector4(163.76, 6633.05, 30.6, 131.82) -- Fishing sell Shop ped location
----------
----------
Config.GemsBuyingPed = `a_m_m_hasjew_01` -- Gems sell Shop ped
Config.GemsBuyingPedLoc = vector4(219.64, -925.23, -105.41, 23.81) -- Gems Buying Ped Location
----------
----------
Config.CrafingRodLocation = vector3(219.64, -925.23, -105.41) -- crafting fishing rods location
----------
----------
