...
Config.InterfaceColor = "#31b9c1" -- change interface color, color must be in hex
...
Config.ReduceStatsTime = {condition = {decreasevalue = 0.5, decreasetime = 120}, strenght = {decreasevalue = 0.5, decreasetime = 120}, water = {decreasevalue = 0.5, decreasetime = 120}} -- decrease time in minutes

Config.Showers = true -- enable shower system

Config.ShowerTime = 25 -- shower time in seconds

Config.OwneableGyms = false -- enable this if you want to have owneable gyms

Config.GymSellMultipler = 0.50 -- money which player will get when he sell gym 

Config.GymPassMultipler = 2.50 -- price for gym pass (its calculated from onetime price to gym)

Config.GymMaxPrice = 155000 -- maximum of gym price for all gyms 

Config.DisableIncreaseStatsNotify = false -- disable notify when some stats increase

Config.DisableDecreaseStatsNotify = true -- disable notify when some stats decrease
...
Config.LungCapacityIncrease = {mintime = 10000, maxtime = 15000} -- minimum and maximum time for increase lung capacity when player is under water.

Config.ConditionIncreaseByNormalRunning = true -- increase condition when player run withount treadmill

Config.ConditionIncrease = {mintime = 10000, maxtime = 15000} -- minimum and maximum time for increase lung capacity when player is under water.

Config.EnergyRegenerate = {mintime = 2500, maxtime = 5000} -- minimum and maximum time for increase lung capacity when player is under water.
...
Config.Gyms = {
	{
		...
		gymprice = 500, -- the price of entry to the gym
		gymtime = 15, -- time a player can be in the gym after payment (in minutes)
		gympassdays = 7, -- after how many days does it take away a person's gym pass
		gymowneable = false, -- enable this if you want to have buyable gyms (you need enable also Config.OwneableGyms)
		gymmanagmentcoords = vector3(-1195.65, -1577.49, 4.6), -- coords for gym buy and managment menu
		gymowneableprice = 125000, -- price of gym for sale
		exercises = {
			{
	...
	{
		gymcoords = vector3(381.2, -1096.81, 29.41), -- coords for blip and also coords for gym menu (if gympayed is disables menu will not show)
		...
		gympassdays = 7, -- after how many days does it take away a person's gym pass
		gymowneable = false, -- enable this if you want to have buyable gyms (you need enable also Config.OwneableGyms)
		gymmanagmentcoords = vector3(362.7, -1094.67, 32.16), -- coords for gym buy and managment menu
		gymowneableprice = 155000, -- price of gym for sale
		exercises = {
			{
				exercisetype = "box", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(377.34, -1095.9, 29.44), 
				heading = 2.6,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},
			{
				exercisetype = "box", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(378.43, -1095.99, 29.44), 
				heading = 2.6,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},
			{
				exercisetype = "box", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(379.59, -1096.03, 29.44), 
				heading = 2.6,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},			
			{
				exercisetype = "run", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(379.79, -1102.89, 29.56), 
				heading = 178.2,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},	
			{
				exercisetype = "run", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(378.33, -1102.99, 29.57), 
				heading = 178.2,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},			
			{
				exercisetype = "run", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(376.86, -1102.96, 29.57), 
				heading = 178.2,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},
			{
				exercisetype = "bench", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(383.81, -1102.29, 29.41), 
				heading = 4.0,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},	
			{
				exercisetype = "bench", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(382.12, -1102.44, 29.41), 
				heading = 4.0,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},	
		--[[ 	{
				exercisetype = "barbell1", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(-1264.13, -356.85, 36.95), 
				heading = 205.5,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},	
			{
				exercisetype = "run", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(-1257.65, -366.58, 37.11), 
				heading = 209.5,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},		
			{
				exercisetype = "run", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(-1259.12, -367.33, 37.11), 
				heading = 209.5,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},
			{
				exercisetype = "run", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(-1260.61, -368.18, 37.11), 
				heading = 209.5,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},	
			{
				exercisetype = "run", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(-1262.05, -369.01, 37.11), 
				heading = 209.5,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},	
			{
				exercisetype = "run", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(-1263.44, -369.74, 37.11), 
				heading = 209.5,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},	
			{
				exercisetype = "run", -- types - bench, squat, chinups, barbell1, barbell2, box, run
				coords = vector3(-1264.76, -370.57, 37.11), 
				heading = 209.5,
				status = {taken = false, takenplayerid = nil}, -- dont edit this
			},				 ]]
		},
...
function Notify(text)
	...
	-- TriggerEvent("QBCore:Notify", "Gym", text, "info", 5000)
