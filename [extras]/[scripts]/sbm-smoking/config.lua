...
------------- 
Config.Armor = 5 -- adds to your armor
Config.AddArmor = 'cigar' -- Config.AddArmor = 'all' | Config.AddArmor = 'off' | Config.AddArmor = 'cigar' | Config.AddArmor = 'cigarette' | Config.AddArmor = 'vape' | Config.AddArmor = 'bong' | Config.AddArmor = 'joint' 
Config.StressSystem = 'all' -- Config.StressSystem = 'all' | Config.StressSystem = 'off' | Config.StressSystem = 'cigar' | Config.StressSystem = 'cigarette' | Config.StressSystem = 'vape' | Config.StressSystem = 'bong' | Config.StressSystem = 'joint' 
...
-----
Config.NotifyMenu = 'helpnotify'-- 3d | helpnotify | textstring
...
function StressTrigger() -- Put inside stress export or trigger
...
Config.Smoke = { -- Item = 
    ...
    {Item = "marlborocig",  Prop = 'ng_proc_cigarette01a', Size = 4, Type = 'cigarette', Time = 120000},
