        ...
        items = {
            {
                ...
                icon = 'store',
                type = 'client',
                event = 'qb-radialmenu:client:togglestore',
                shouldClose = true,
            },
            {
                id    = 'bank',
                ...
                icon = 'university',
                type = 'client',
                event = 'qb-radialmenu:client:togglebank',
                shouldClose = true,
            },
            {
                id    = 'tattooshop',
            ...
            },
            {
                ...
                icon = 'car',
                type = 'client',
                event = 'qb-radialmenu:client:togglegarage',
                shouldClose = true,
            },
            {
                id    = 'gasstation',
            ...
            },
            {
                ...
                icon = 'boxes',
                type = 'client',
                event = 'qb-radialmenu:client:toggleammunation',
                shouldClose = true,
            },
        }, 
    },
