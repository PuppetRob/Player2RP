...
QBShared.Jobs = {
	...
	ambulance = {
		...
		offDutyPay = false,
		grades = {
			['0'] = { name = 'EMT', payment = 1200 },
			['1'] = { name = 'Nurse', payment = 1400 },
			['2'] = { name = 'Doctor', payment = 2000 },
			['3'] = { name = 'Chief Doctor', payment = 2400 },
			['4'] = { name = 'Chief Surgeon', payment = 2400 },
			['5'] = { name = 'Assistant Chief', payment = 2800 },
	...
	cardealer = {
		...
		grades = {
			['0'] = { name = 'Recruit', payment = 1200 },
			['1'] = { name = 'Showroom Sales', payment = 1400 },
			['2'] = { name = 'Business Sales', payment = 1600 },
			['3'] = { name = 'Finance', payment = 1800 },
	...
	taxi = {
		...
		grades = {
			['0'] = { name = 'Recruit', payment = 1200 },
			['1'] = { name = 'Driver', payment = 1400 },
			['2'] = { name = 'Event Driver', payment = 1600 },
			['3'] = { name = 'Sales', payment = 1800 },
			['4'] = { name = 'Manager', isboss = true, payment = 2000 },
		},
	},
