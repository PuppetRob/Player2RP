...
local Vehicles = {
    ...
    { model = 'panto',         name = 'Panto',                         brand = 'Benefactor',      price = 5000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'prairie',       name = 'Prairie',                       brand = 'Bollokan',        price = 24000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    ...
    { model = 'brioso3',       name = 'Brioso 300 Widebody',           brand = 'Grotti',          price = 25000,  category = 'compacts',       type = 'automobile', shop = 'pdm' },
    ...
    { model = 'baller7',       name = 'Baller ST',                     brand = 'Gallivanter',     price = 94000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'jubilee',       name = 'Jubilee',                       brand = 'Enus',            price = 68500,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'oracle',        name = 'Oracle',                        brand = 'Übermacht',       price = 22000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'schafter2',     name = 'Schafter',                      brand = 'Benefactor',      price = 38000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'baller2',       name = 'Baller II',                     brand = 'Gallivanter',     price = 23000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'baller3',       name = 'Baller LE',                     brand = 'Gallivanter',     price = 24000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'landstalker',   name = 'Landstalker',                   brand = 'Dundreary',       price = 35000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'landstalker2',  name = 'Landstalker XL',                brand = 'Dundreary',       price = 42000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'novak',         name = 'Novak',                         brand = 'Lampadati',       price = 70000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'patriot',       name = 'Patriot',                       brand = 'Mammoth',         price = 78000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'patriot2',      name = 'Patriot Stretch',               brand = 'Mammoth',         price = 108000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'radi',          name = 'Radius',                        brand = 'Vapid',           price = 18000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'rebla',         name = 'Rebla GTS',                     brand = 'Übermacht',       price = 98000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'seminole2',     name = 'Seminole Frontier',             brand = 'Canis',           price = 32000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'serrano',       name = 'Serrano',                       brand = 'Benefactor',      price = 48000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'toros',         name = 'Toros',                         brand = 'Pegassi',         price = 250000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'xls',           name = 'XLS',                           brand = 'Benefactor',      price = 32000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'granger2',      name = 'Granger 3600LX',                brand = 'Declasse',        price = 42000,  category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'patriot3',      name = 'Patriot Military',              brand = 'Mil-Spec',        price = 134000,  category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    --- Coupes (3)
    { model = 'cogcabrio',     name = 'Cognoscenti Cabrio',            brand = 'Enus',            price = 35000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'felon',         name = 'Felon',                         brand = 'Lampadati',       price = 42000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'felon2',        name = 'Felon GT',                      brand = 'Lampadati',       price = 55000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'sentinel',      name = 'Sentinel',                      brand = 'Übermacht',       price = 32000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'sentinel2',     name = 'Sentinel XS',                   brand = 'Übermacht',       price = 38000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'sentinel3',     name = 'Sentinel Classic',              brand = 'Übermacht',       price = 86000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'kanjosj',       name = 'Kanjo SJ',                      brand = 'Dinka',           price = 55000,  category = 'coupes',         type = 'automobile', shop = 'pdm' },
   ...
   --- { model = 'dominator2',    name = 'Pißwasser Dominator',           brand = 'Vapid',           price = 50000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'dominator7',    name = 'Dominator ASP',                 brand = 'Vapid',           price = 95000,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'dominator8',    name = 'Dominator GTT',                 brand = 'Vapid',           price = 110000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'dukes3',        name = 'Beater Dukes',                  brand = 'Imponte',         price = 38000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'ellie',         name = 'Ellie',                         brand = 'Vapid',           price = 38000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
   ...
   -- { model = 'gauntlet2',     name = 'Redwood Gauntlet',              brand = 'Bravado',         price = 70000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'hermes',        name = 'Hermes',                        brand = 'Albany',          price = 153500,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'ratloader2',    name = 'Ratloader',                     brand = 'Ratloader2',      price = 69000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'slamvan3',      name = 'Slam Van Custom',               brand = 'Vapid',           price = 115000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
 ...
 --   { model = 'stalion2',      name = 'Stallion Burgershot',           brand = 'Declasse',        price = 40000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'tulip',         name = 'Tulip',                         brand = 'Declasse',        price = 85000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'vamos',         name = 'Vamos',                         brand = 'Declasse',        price = 42000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'virgo2',        name = 'Virgo Custom Classic',          brand = 'Dundreary',       price = 25000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'virgo3',        name = 'Virgo Classic',                 brand = 'Dundreary',       price = 26000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'buffalo4',      name = 'Buffalo STX',                   brand = 'Bravado',         price = 118000,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'tulip2',        name = 'Tulip M-100',                   brand = 'Declasse',        price = 90000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'clique2',       name = 'Clique Wagon',                  brand = 'Vapid',           price = 22500,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'brigham',       name = 'Brigham',                       brand = 'Albany',          price = 14900,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'btype',         name = 'Roosevelt',                     brand = 'Albany',          price = 63000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'btype2',        name = 'Franken Stange',                brand = 'Albany',          price = 87000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'btype3',        name = 'Roosevelt Valor',               brand = 'Albany',          price = 75000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    ...
    { model = 'infernus2',     name = 'Infernus Classic',              brand = 'Pegassi',         price = 970000,  category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    ...
    { model = 'pigalle',       name = 'Pigalle',                       brand = 'Lampadati',       price = 34000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'rapidgt3',      name = 'Rapid GT Classic',              brand = 'Dewbauchee',      price = 90000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'retinue',       name = 'Retinue',                       brand = 'Vapid',           price = 78000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'retinue2',      name = 'Retinue MKII',                  brand = 'Vapid',           price = 84000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'savestra',      name = 'Savestra',                      brand = 'Annis',           price = 78000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'stinger',       name = 'Stinger',                       brand = 'Grotti',          price = 80000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'stingergt',     name = 'Stinger GT',                    brand = 'Grotti',          price = 85000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    --{ model = 'stromberg',     name = 'Stromberg',                     brand = 'Ocelot',          price = 80000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'swinger',       name = 'Swinger',                       brand = 'Ocelot',          price = 85000,  category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    ...
    { model = 'turismo2',      name = 'Turismo Classic',               brand = 'Grotti',          price = 1005000,  category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'viseris',       name = 'Viseris',                       brand = 'Lampadati',       price = 425000,  category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    { model = 'z190',          name = '190Z',                          brand = 'Karin',           price = 90000,   category = 'sportsclassics', type = 'automobile', shop = 'pdm' },
    ...
    { model = 'flashgt',       name = 'Flash GT',                      brand = 'Vapid',           price = 65000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'imorgon',       name = 'Imorgon',                       brand = 'Överflöd',        price = 300000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'italigto',      name = 'Itali GTO',                     brand = 'Progen',          price = 1065000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'jugular',       name = 'Jugular',                       brand = 'Ocelot',          price = 145000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
   ...
   -- { model = 'massacro2',     name = 'Massacro Racecar',              brand = 'Dewbauchee',      price = 80000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'neo',           name = 'Neo',                           brand = 'Vysser',          price = 2030000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'neon',          name = 'Neon',                          brand = 'Pfister',         price = 263000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'paragon',       name = 'Paragon',                       brand = 'Enus',            price = 158000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'pariah',        name = 'Pariah',                        brand = 'Ocelot',          price = 142000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'penumbra',      name = 'Penumbra',                      brand = 'Maibatsu',        price = 22000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'penumbra2',     name = 'Penumbra FF',                   brand = 'Maibatsu',        price = 115000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'ruston',        name = 'Ruston',                        brand = 'Hijak',           price = 201000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'schafter3',     name = 'Schafter V12',                  brand = 'Benefactor',      price = 56000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'schafter4',     name = 'Schafter LWB',                  brand = 'Benefactor',      price = 48000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'streiter',      name = 'Streiter',                      brand = 'Benefactor',      price = 73000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'sultan2',       name = 'Sultan Custom',                 brand = 'Karin',           price = 70000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'verlierer2',    name = 'Verlierer',                     brand = 'Bravado',         price = 190500,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'vstr',          name = 'V-STR',                         brand = 'Albany',          price = 80000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'italirsx',      name = 'Itali RSX',                     brand = 'Progen',          price = 1060000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'zr350',         name = 'ZR350',                         brand = 'Annis',           price = 120000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'jester4',       name = 'Jester RR',                     brand = 'Dinka',           price = 155000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'remus',         name = 'Remus',                         brand = 'Annis',           price = 56000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'sultan3',       name = 'Sultan Classic Custom',         brand = 'Karin',           price = 60000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'rt3000',        name = 'RT3000',                        brand = 'Dinka',           price = 111000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'sultanrs',      name = 'Sultan RS',                     brand = 'Karin',           price = 160000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'visione',       name = 'Visione',                       brand = 'Grotti',          price = 2250000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'cheetah2',      name = 'Cheetah Classic',               brand = 'Grotti',          price = 195000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'stingertt',     name = 'Itali GTO Stinger TT',          brand = 'Maibatsu',        price = 890000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'omnisegt',      name = 'Omnis e-GT',                    brand = 'Obey',            price = 185000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'sentinel4',     name = 'Sentinel Classic Widebody',     brand = 'Übermacht',       price = 94000,  category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'everon2',       name = 'Everon Hotring',                brand = 'Karin',           price = 94000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'issi8',         name = 'Issi Rally',                    brand = 'Weeny',           price = 40000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'panthere',      name = 'Panthere',                      brand = 'Toundra',         price = 124000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    --- Super (7)
    ...
    { model = 'entity2',       name = 'Entity XXR',                    brand = 'Överflöd',        price = 1064000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'entityxf',      name = 'Entity XF',                     brand = 'Överflöd',        price = 1050000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'emerus',        name = 'Emerus',                        brand = 'Progen',          price = 1100000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'fmj',           name = 'FMJ',                           brand = 'Vapid',           price = 1205000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'furia',         name = 'Furia',                         brand = 'Grotti',          price = 1000500,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'gp1',           name = 'GP1',                           brand = 'Progen',          price = 1010000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'infernus',      name = 'Infernus',                      brand = 'Pegassi',         price = 985000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'italigtb',      name = 'Itali GTB',                     brand = 'Progen',          price = 1700000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'italigtb2',     name = 'Itali GTB Custom',              brand = 'Progen',          price = 2050000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'krieger',       name = 'Krieger',                       brand = 'Benefactor',      price = 1300000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'le7b',          name = 'RE-7B',                         brand = 'Annis',           price = 1350000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'nero',          name = 'Nero',                          brand = 'Truffade',        price = 2000000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'nero2',         name = 'Nero Custom',                   brand = 'Truffade',        price = 2060000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'osiris',        name = 'Osiris',                        brand = 'Pegassi',         price = 2020000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'penetrator',    name = 'Penetrator',                    brand = 'Ocelot',          price = 1300000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'pfister811',    name = '811',                           brand = 'Pfister',         price = 2040000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'prototipo',     name = 'X80 Proto',                     brand = 'Grotti',          price = 2500000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'reaper',        name = 'Reaper',                        brand = 'Pegassi',         price = 1500000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 's80',           name = 'S80RR',                         brand = 'Annis',           price = 2050000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'sc1',           name = 'SC1',                           brand = 'Übermacht',       price = 1603000,   category = 'super',          type = 'automobile', shop = 'pdm' },
    ...
    { model = 'tezeract',      name = 'Tezeract',                      brand = 'Pegassi',         price = 2250000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'thrax',         name = 'Thrax',                         brand = 'Truffade',        price = 1850000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'tigon',         name = 'Tigon',                         brand = 'Lampadati',       price = 2040000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'turismor',      name = 'Turismo R',                     brand = 'Grotti',          price = 1040000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'tyrant',        name = 'Tyrant',                        brand = 'Överflöd',        price = 2100000, category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'tyrus',         name = 'Tyrus',                         brand = 'Progen',          price = 2030000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    ...
    { model = 'zentorno',      name = 'Zentorno',                      brand = 'Pegassi',         price = 1500000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'zorrusso',      name = 'Zorrusso',                      brand = 'Pegassi',         price = 2077000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    ...
    { model = 'deveste',       name = 'Deveste',                       brand = 'Principe',        price = 1200000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'lm87',          name = 'LM87',                          brand = 'Benefactor',      price = 1505000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'torero2',       name = 'Torero XO',                     brand = 'Pegassi',         price = 2405000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'entity3',       name = 'Entity MT',                     brand = 'Overflod',        price = 1500000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'virtue',        name = 'Virtue',                        brand = 'Ocelot',          price = 3100000,   category = 'super',          type = 'automobile', shop = 'pdm' },
    { model = 'turismo3',      name = 'Turismo Omaggio',               brand = 'Grotti',          price = 284500,   category = 'super',         type = 'automobile', shop = 'pdm' },
     ...
     -- { model = 'blazer5',       name = 'Blazer Aqua',                   brand = 'Nagasaki',        price = 40000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
      ...
      { model = 'dubsta3',       name = 'Dubsta 6x6',                    brand = 'Annis',           price = 89000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
      ...
      { model = 'freecrawler',   name = 'Freecrawler',                   brand = 'Canis',           price = 78000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
      { model = 'hellion',       name = 'Hellion',                       brand = 'Annis',           price = 38500,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
      ...
      { model = 'mesa3',         name = 'Mesa Merryweather',             brand = 'Canis',           price = 68000,  category = 'offroad',        type = 'automobile', shop = 'pdm' },
      { model = 'rancherxl',     name = 'Rancher XL',                    brand = 'Declasse',        price = 24000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
      { model = 'rebel2',        name = 'Rebel',                         brand = 'Vapid',           price = 35000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
      { model = 'riata',         name = 'Riata',                         brand = 'Vapid',           price = 102000,  category = 'offroad',        type = 'automobile', shop = 'pdm' },
      { model = 'sandking',      name = 'Sandking XL',                   brand = 'Vapid',           price = 65000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
      ...
      { model = 'verus',         name = 'Verus',                         brand = 'Dinka',           price = 10000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
      { model = 'winky',         name = 'Winky',                         brand = 'Vapid',           price = 10000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
      { model = 'yosemite3',     name = 'Yosemite Rancher',              brand = 'Declasse',        price = 43500,  category = 'offroad',        type = 'automobile', shop = 'pdm' },
      { model = 'mesa',          name = 'Mesa',                          brand = 'Canis',           price = 12000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
      { model = 'ratel',         name = 'Ratel',                         brand = 'Vapid',           price = 46000,  category = 'offroad',        type = 'automobile', shop = 'pdm' },
      { model = 'l35',           name = 'Walton L35',                    brand = 'Declasse',        price = 45000,  category = 'offroad',        type = 'automobile', shop = 'pdm' },
    ...
    { model = 'burrito3',      name = 'Burrito',                       brand = 'Declasse',        price = 19000,    category = 'vans',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'paradise',      name = 'Paradise',                      brand = 'Bravado',         price = 19000,    category = 'vans',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'youga3',        name = 'Youga Classic 4x4',             brand = 'Bravado',         price = 25000,   category = 'vans',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'youga4',        name = 'Youga Custom',                  brand = 'Bravado',         price = 42069,   category = 'vans',           type = 'automobile', shop = 'pdm' },
   ...
   -- { model = 'taco',          name = 'Taco Truck',                    brand = 'Brute',           price = 45000,   category = 'vans',           type = 'automobile', shop = 'pdm' },
    ...
    --- Motorcycles (8)
    { model = 'akuma',         name = 'Akuma',                         brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'avarus',        name = 'Avarus',                        brand = 'LCC',             price = 20000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'bagger',        name = 'Bagger',                        brand = 'WMC',             price = 13500,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'bati',          name = 'Bati 801',                      brand = 'Pegassi',         price = 24000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'bati2',         name = 'Bati 801RR',                    brand = 'Pegassi',         price = 19000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'bf400',         name = 'BF400',                         brand = 'Nagasaki',        price = 22000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'carbonrs',      name = 'Carbon RS',                     brand = 'Nagasaki',        price = 22000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'chimera',       name = 'Chimera',                       brand = 'Nagasaki',        price = 21000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'cliffhanger',   name = 'Cliffhanger',                   brand = 'Western',         price = 28500,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'daemon',        name = 'Daemon',                        brand = 'WMC',             price = 14000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'daemon2',       name = 'Daemon Custom',                 brand = 'Western',         price = 23000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'defiler',       name = 'Defiler',                       brand = 'Shitzu',          price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'deathbike',     name = 'Deathbike Apocalypse',          brand = 'Deathbike',       price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'deathbike2',    name = 'Deathbike Future Shock',        brand = 'Deathbike',       price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'deathbike3',    name = 'Deathbike Nightmare',           brand = 'Deathbike',       price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'diablous',      name = 'Diablous',                      brand = 'Principe',        price = 30000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'diablous2',     name = 'Diablous Custom',               brand = 'Principe',        price = 38000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'double',        name = 'Double-T',                      brand = 'Dinka',           price = 28000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'enduro',        name = 'Enduro',                        brand = 'Dinka',           price = 5500,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'esskey',        name = 'Esskey',                        brand = 'Pegassi',         price = 12000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'faggio',        name = 'Faggio Sport',                  brand = 'Pegassi',         price = 2000,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'faggio2',       name = 'Faggio',                        brand = 'Pegassi',         price = 1900,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'faggio3',       name = 'Faggio Mod',                    brand = 'Pegassi',         price = 2500,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'fcr',           name = 'FCR 1000',                      brand = 'Pegassi',         price = 5000,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'fcr2',          name = 'FCR 1000 Custom',               brand = 'Pegassi',         price = 19000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'gargoyle',      name = 'Gargoyle',                      brand = 'Western',         price = 32000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'hakuchou',      name = 'Hakuchou',                      brand = 'Shitzu',          price = 17000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'hakuchou2',     name = 'Hakuchou Drag',                 brand = 'Shitzu',          price = 45000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'hexer',         name = 'Hexer',                         brand = 'LCC',             price = 16000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'innovation',    name = 'Innovation',                    brand = 'LLC',             price = 33500,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'lectro',        name = 'Lectro',                        brand = 'Principe',        price = 28000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'manchez',       name = 'Manchez',                       brand = 'Maibatsu',        price = 8300,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'nemesis',       name = 'Nemesis',                       brand = 'Principe',        price = 20000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'nightblade',    name = 'Nightblade',                    brand = 'WMC',             price = 23000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'pcj',           name = 'PCJ-600',                       brand = 'Shitzu',          price = 15000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'ratbike',       name = 'Rat Bike',                      brand = 'Western',         price = 3000,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'ruffian',       name = 'Ruffian',                       brand = 'Pegassi',         price = 25000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'sanchez',       name = 'Sanchez Livery',                brand = 'Maibatsu',        price = 5300,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'sanchez2',      name = 'Sanchez',                       brand = 'Maibatsu',        price = 5300,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'sanctus',       name = 'Sanctus',                       brand = 'LCC',             price = 35000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'shotaro',       name = 'Shotaro',                       brand = 'Nagasaki',        price = 320000,  category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'sovereign',     name = 'Sovereign',                     brand = 'WMC',             price = 8000,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'stryder',       name = 'Stryder',                       brand = 'Nagasaki',        price = 50000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'thrust',        name = 'Thrust',                        brand = 'Dinka',           price = 22000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'vader',         name = 'Vader',                         brand = 'Shitzu',          price = 7200,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'vindicator',    name = 'Vindicator',                    brand = 'Dinka',           price = 19000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'vortex',        name = 'Vortex',                        brand = 'Pegassi',         price = 31000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'wolfsbane',     name = 'Wolfsbane',                     brand = 'Western',         price = 14000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'zombiea',       name = 'Zombie Bobber',                 brand = 'Western',         price = 28000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'zombieb',       name = 'Zombie Chopper',                brand = 'Western',         price = 27000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'manchez2',      name = 'Manchez Scout',                 brand = 'Maibatsu',        price = 14000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'shinobi',       name = 'Shinobi',                       brand = 'Nagasaki',        price = 25000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'reever',        name = 'Reever',                        brand = 'Western',         price = 25000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'manchez3',      name = 'Manchez Scout Classic',         brand = 'Maibatsu',        price = 15000,   category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },
    { model = 'powersurge',    name = 'Powersurge',                    brand = 'Western',         price = 7000,    category = 'motorcycles',    type = 'bike',       shop = 'bikeshop' },

    --- Cycles (13)
    { model = 'bmx',           name = 'BMX',                           brand = 'Bike',            price = 160,     category = 'cycles',         type = 'bike',       shop = 'bikeshop' },
    { model = 'cruiser',       name = 'Cruiser',                       brand = 'Bike',            price = 510,     category = 'cycles',         type = 'bike',       shop = 'bikeshop' },
    { model = 'fixter',        name = 'Fixter',                        brand = 'Bike',            price = 225,     category = 'cycles',         type = 'bike',       shop = 'bikeshop' },
    { model = 'scorcher',      name = 'Scorcher',                      brand = 'Bike',            price = 280,     category = 'cycles',         type = 'bike',       shop = 'bikeshop' },
    { model = 'tribike',       name = 'Whippet Race Bike',             brand = 'Bike',            price = 500,     category = 'cycles',         type = 'bike',       shop = 'bikeshop' },
    { model = 'tribike2',      name = 'Endurex Race Bike',             brand = 'Bike',            price = 700,     category = 'cycles',         type = 'bike',       shop = 'bikeshop' },
    { model = 'tribike3',      name = 'Tri-Cycles Race Bike',          brand = 'Bike',            price = 520,     category = 'cycles',         type = 'bike',       shop = 'bikeshop' },
    { model = 'inductor',      name = 'Inductor',                      brand = 'Coil',            price = 5000,    category = 'cycles',         type = 'bike',       shop = 'bikeshop' },
    { model = 'inductor2',     name = 'Junk Energy Inductor',          brand = 'Coil',            price = 5000,    category = 'cycles',         type = 'bike',       shop = 'bikeshop' },
