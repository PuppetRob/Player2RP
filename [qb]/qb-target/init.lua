...
target = {
   ...
   {   -- Paleto Pawn
	   ...
	   coords = vector4(1704.94, 3784.66, 34.71, 216.25),
	   networked = false,
	   invincible = true,
	   blockevents = true,
	   target = {
   ...
   {   -- Sandy Pawn
	   model = `a_f_y_hippie_01`,
	   coords = vector4(138.95, -1783.61, 29.73, 53.76),
	   networked = false,
	   invincible = true,
	   blockevents = true,
	   target = {
   ...
   {   -- Phone Repair
	   model = `a_f_y_hippie_01`,
	   coords = vector4(-780.06, -618.36, 30.28, 1.6),
	   networked = false,
	   invincible = true,
	   blockevents = true,
	   target = {
		   options = {
			   {
				   type = "client",
				   event = "qs-smartphone:OpenTechMenu",
				   icon = "fas fa-sign-in-alt",
				   label = "Talk to Phone Tech",
