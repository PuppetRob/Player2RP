...
Config.DurabilityMultiplier = {
    ...
    weapon_bottle                = 0.08,
    weapon_crowbar               = 0.08,
    weapon_candycane             = 0.08,
    -- weapon_flashlight 			 = 0.08,
    weapon_golfclub              = 0.08,
    weapon_hammer                = 0.08,
    weapon_hatchet               = 0.08,
    weapon_knuckle               = 0.08,
    weapon_knife                 = 0.08,
    weapon_machete               = 0.08,
    weapon_switchblade           = 0.08,
    -- weapon_nightstick 			 = 0.08,
    weapon_wrench                = 0.08,
    weapon_battleaxe             = 0.08,
    weapon_poolcue               = 0.08,
    weapon_briefcase             = 0.08,
    weapon_briefcase_02          = 0.08,
    weapon_garbagebag            = 0.08,
    weapon_handcuffs             = 0.08,
    weapon_bread                 = 0.08,
    weapon_stone_hatchet         = 0.08,

    -- Handguns
    weapon_pistol                = 0.08,
    weapon_pistol_mk2            = 0.08,
    weapon_combatpistol          = 0.08,
    weapon_appistol              = 0.08,
    -- weapon_stungun 				 = 0.08,
    -- weapon_stungun_mp 				 = 0.08,
    weapon_pistol50              = 0.08,
    weapon_snspistol             = 0.08,
    weapon_heavypistol           = 0.08,
    weapon_vintagepistol         = 0.08,
    weapon_flaregun              = 0.08,
    weapon_marksmanpistol        = 0.08,
    weapon_revolver              = 0.08,
    weapon_revolver_mk2          = 0.08,
    weapon_doubleaction          = 0.08,
    weapon_snspistol_mk2         = 0.08,
    weapon_raypistol             = 0.08,
    weapon_ceramicpistol         = 0.08,
    weapon_navyrevolver          = 0.08,
    weapon_gadgetpistol          = 0.08,
    weapon_pistolxm3             = 0.08,
    ...
    weapon_combatpdw             = 0.08,
    weapon_machinepistol         = 0.08,
    weapon_minismg               = 0.08,
    ...
    weapon_assaultshotgun        = 0.08,
    weapon_bullpupshotgun        = 0.08,
    weapon_musket                = 0.08,
    weapon_heavyshotgun          = 0.08,
    weapon_dbshotgun             = 0.08,
    weapon_autoshotgun           = 0.08,
    weapon_pumpshotgun_mk2       = 0.08,
    weapon_combatshotgun         = 0.08,

    -- Assault Rifles
    weapon_assaultrifle          = 0.08,
    weapon_assaultrifle_mk2      = 0.08,
    weapon_carbinerifle          = 0.08,
    weapon_carbinerifle_mk2      = 0.08,
    weapon_advancedrifle         = 0.08,
    weapon_specialcarbine        = 0.08,
    weapon_bullpuprifle          = 0.08,
    weapon_compactrifle          = 0.08,
    weapon_specialcarbine_mk2    = 0.08,
    weapon_bullpuprifle_mk2      = 0.08,
    weapon_militaryrifle         = 0.08,
    weapon_heavyrifle            = 0.08,

    -- Light Machine Guns
    weapon_mg                    = 0.08,
    weapon_combatmg              = 0.08,
    weapon_gusenberg             = 0.08,
    weapon_combatmg_mk2          = 0.08,

    -- Sniper Rifles
    weapon_sniperrifle           = 0.08,
    weapon_heavysniper           = 0.08,
    weapon_marksmanrifle         = 0.08,
    weapon_remotesniper          = 0.08,
    weapon_heavysniper_mk2       = 0.08,
    weapon_marksmanrifle_mk2     = 0.08,

    -- Heavy Weapons
    weapon_rpg                   = 0.08,
    weapon_grenadelauncher       = 0.08,
    weapon_grenadelauncher_smoke = 0.08,
    weapon_emplauncher           = 0.08,
    weapon_minigun               = 0.08,
    weapon_firework              = 0.08,
    weapon_railgun               = 0.08,
    weapon_hominglauncher        = 0.08,
    weapon_compactlauncher       = 0.08,
    weapon_rayminigun            = 0.08,
    weapon_railgunxm3            = 0.08,

    -- Throwables
    weapon_grenade               = 0.08,
    weapon_bzgas                 = 0.08,
    weapon_molotov               = 0.08,
    weapon_stickybomb            = 0.08,
    weapon_proxmine              = 0.08,
    weapon_snowball              = 0.08,
    weapon_pipebomb              = 0.08,
    weapon_ball                  = 0.08,
    weapon_smokegrenade          = 0.08,
    weapon_flare                 = 0.08,

    -- Miscellaneous
    weapon_petrolcan             = 0.08,
